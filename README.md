...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/newimg)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/newimg
```

A live public deployment of this template is available at [https://newimg.templates.workers.dev](https://newimg.templates.workers.dev)
